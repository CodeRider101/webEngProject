...
export let startConfetti; //call to start confetti animation
export let stopConfetti; //call to stop adding confetti
...
(function() {
	...
	let colors = ['#f44336', '#00C09D', '#2196f3', '##4b22b3', "Gold", "SlateBlue", "Violet", "PaleGreen", "Chocolate", "Crimson"]
